defmodule Babble.Presence do
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Babble.MyChannel do
        use BabbleWeb, :channel
        alias Babble.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :babble,
                        pubsub_server: Babble.PubSub
end
